...
namespace C<DBI2> in place of its current C<Muldis::DBI::Duck_Coupling> name.
...
modules adapted to this new C<DBI2> would by default have their
corresponding Perl 5 C<DBD2::*> names, though they can also be free to pick
new names of their choosing, as this new C<DBI2> would not place any
