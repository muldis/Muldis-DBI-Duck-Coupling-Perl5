...
I<TODO: For all intents and purposes, this API is intended as a direct
replacement for DBI itself, such as if DBI itself had a rewrite, or if this
were a DBI2 etc.  The Perl 6 version could BE the first "DBI" there.
Thus DBI is part of the name, not DBIx or whatever.  Ideally Tim Bunce would
bless this as the official DBI successor / major new version, and eventually
it could even gain the name "DBI" or "DBI2" in Perl 5.>
