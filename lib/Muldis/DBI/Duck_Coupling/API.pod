...
Perl 5 has a direct analogy to a C<Reference> which is a Perl 5 scalar
...
foundation for Perl 5 code that is able to speak the B<Muldis Duck Coupling
DBI> API.  The API makes heavy use of basic Perl 5 references and objects,
